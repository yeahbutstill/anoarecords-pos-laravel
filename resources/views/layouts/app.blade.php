...
<head>
  ...
  <title>{{ config('app.name') }} {{ config('app.last_name') }}</title>
  ...
  <link rel="stylesheet" href="{{ asset('public/adminLTE/dist/css/skins/skin-black.min.css') }}">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="#" class="logo">
        ...
        <span class="logo-lg"><b>Anoa</b>Records</span>
      </a>
    ...
    <footer class="main-footer" style="padding:20px;">
      <div class="pull-right hidden-xs">
        <strong>&copy; 2020 <a href="#">Anoa</a>.</strong> All rights reserved.
      </div>
